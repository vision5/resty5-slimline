...
=head1 I Can Haz Fuzz?



=head1 LibFuzzer

Or, how to fuzz OpenSSL with L<libfuzzer|http://llvm.org/docs/LibFuzzer.html>.
...
Where $FUZZER is one of the executables in C<fuzz/>.

If you get a crash, you should find a corresponding input file in
C<fuzz/corpora/$FUZZER-crash/>. You can reproduce the crash with
