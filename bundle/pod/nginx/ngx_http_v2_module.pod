...
an L<HPACK|https://tools.ietf.org/html/rfc7541>-compressed
...
L<HPACK|https://tools.ietf.org/html/rfc7541> decompression.
For most requests, the default limit should be enough.
...
Pre-emptively sends
(L<pushes|https://tools.ietf.org/html/rfc7540#section-8.2>)
...
L<push|https://tools.ietf.org/html/rfc7540#section-8.2>
requests.
